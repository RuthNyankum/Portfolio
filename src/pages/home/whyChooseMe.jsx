...
const WhyChooseMe = () => {
  return (
    <div className="bg-gray-900 text-white p-6 flex justify-center poppins-regular">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-[90rem] mx-auto border-4 border-primary">
        {/* Wrapper for Text and Cards */}
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="flex-1 text-center md:text-left md:pr-10">
            ...
            <Link
              to="/contact-me"
              className="px-6 py-2 text-black bg-white rounded hover:bg-primary flex items-center mx-auto md:mx-0 w-36 text-center"
            >
              Contact Me
            </Link>
          </div>
          ...
          {/* Card Section */}
          <div className="grid grid-cols-1 gap-6 mt-8 md:mt-0 md:ml-10 md:w-[300px]">
            <div className="bg-gray-700 p-4 rounded-lg text-center">
              <FaLightbulb className="text-primary text-6xl mb-2 mx-auto" />
              <p className="text-lg">
                "Ready to create exceptional experiences."
